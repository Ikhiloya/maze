...
import com.loya.maze.resource.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public User registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        userRepository.findOneByLogin(managedUserVM.getLogin().toLowerCase()).ifPresent(u -> {throw new ResourceNotFoundException("login already in use");});
        userRepository.findOneByEmailIgnoreCase(managedUserVM.getEmail()).ifPresent(u -> {throw new ResourceNotFoundException("Email already in use");});
...
//     */
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        final String userLogin = SecurityUtils.getCurrentUserLogin().orElseThrow(() ->
                new ResourceNotFoundException("Current user login not found"));
